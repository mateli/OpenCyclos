...
<br><br>Alle configuratie met betrekking to rekeningen en transacties 
geschiedit in het rekeningenbeheer

<i>Waar te vinden</i><br>
Rekeningenbeheer is te vinden via &quot;Menu: Rekeningen > Beheer rekeningen&quot;.
<hr>
...
Administrators that have the autorisaties can make payments from these system
...
<ol>
	...
	<li><b>Permissions:</b> Of course, you will also need to set the <a
		href="${pagePrefix}groups#manage_groups"><u>autorisaties</u></a>.
</ol>
...
transaction type.
<br><br>Note1: The autorisaties of a transaction type are defined per group and
...
<ul>
	...
	this overview and no autorisaties have been set for the member group. Same
	...
	More information about <a href="${pagePrefix}payments#geautoriseerd"><u>geautoriseerd
	payments</u></a> can be found in the help of <a href="#geautoriseerd_payment_levels"><u>that
	window</u></a> .<br>
	...
	able to use the schedule option. You still need to set the autorisaties per
...
<br><br><A NAME="geautoriseerd_payment_levels"></A>
<h3>Authorization levels</h3>
This function will allow to define levels of authorization for a payment type
which needs <a href="${pagePrefix}payments#geautoriseerd"><u> authorization</u></a>.
...
type. If none is available you will have to click the &quot;New geautoriseerd
payment level&quot;, because you will have to define at least one level of
authorization for each geautoriseerd payment type. When you add a new level it will
show up in the list.<br>
If levels already have been defined, you have the following options:
<ul>
	<li><img border="0" src="${images}/edit.gif" width="16" height="16">
	Click the icon to modify the geautoriseerd payment level.
	<li><img border="0" src="${images}/delete.gif" width="16" height="16">
	Click the icon if you want to delete the geautoriseerd payment level.
</ul>
...
geautoriseerd as a whole (and the total amount blocked/reserved until
authorization).
<hr class="help">

<A NAME="edit_authorization_level"></A>
<h3>Edit Authorization level</h3>
In this window you can define the <a href="#geautoriseerd_payment_levels"><u>
...
<ul>
	...
	&quot;accept&quot; from the pending geautoriseerd payments list) the amount will
	...
	will remain in the pending status after a Receiver geautoriseerd. Now the the
...
want the payment always to be geautoriseerd you can put a zero in the amount field.
If you put an amount, say 1000, it means that if a member pays more than 1000
during 24 hours, the exceeding payment will need to be geautoriseerd. <br>
