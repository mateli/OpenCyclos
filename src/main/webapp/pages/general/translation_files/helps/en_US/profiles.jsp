...
<ul>
	...
	<li><b>Via your contacts:</b> Use your <a href="${pagePrefix}user_management#contacts"><u>contact
...
set explicitly which profiles of other groups may be viewed by them (first item below).
...
<ul>
	...
	<li>For an admin to be able to change a member's profile, you need to set the 
	<a href="${pagePrefix}groups#manage_group_permissions_admin_member"><u>permissions</u></a>
	for this under the block &quot;members&quot;, and check the checkbox &quot;change profile&quot;.
...
<span class="member">
<br><br>
Of course, the profile of other members cannot be modified, and the
...
<br><br>
Some general information on the form:
<ul>
...
The form is pretty straightforward, and most items are self-explanatory.
...
<a href="#top"><u>profile</u></a>or advertisement. 
Follow these directions if you want other members to be able to see your picture:
<ol>
	...
	<li>After that, the name of the file is placed in the &quot;Picture&quot; box.
...
<UL>
	...
	transaction.
	<LI><b>Send </b> <a href="${pagePrefix}invoices"><u>invoice</u></a>
	<li><b>View </b> <a href="${pagePrefix}advertisements"><u>advertisements</u></a>
	<li><b>Send e-mail</b>
	...
	<LI><b>Add to </b><a href="${pagePrefix}user_management#contacts"><u>contact list</u></a>
</UL>
<hr class="help">
</span>
...
help section, in order to keep the length of blocks of text manageable and readable.
<br><br>
The following sections exist. Click on the links to move to the
...
<ul>
	...
	messages sent to this member are kept. The system can be configured to send SMS
	messages on several occasions.
	<li><b>Manage cards:</b> gives you access to the <a
	href="${pagePrefix}access_devices#search_card_results"><u> Manage cards</u></a>
   ,where will be listed every members card.
</ul>
<hr class="help">
</span>
...
<ul>
	...
	the members are able to see those remarks. If the remark text before the submit
	button is red it means that it contains a remark. If there is no text in the
	remark field the remark text will remain in the default text colour of the application.
	<li><b>...:</b> any other <a href="${pagePrefix}member_records"><u>member
	record</u></a> types you defined will be listed here too with a button.
	<li><b>Manage references:</b> Here you can see how other members value
	this member, and you can see what kind of experiences this member has had with
	...
	(if he has the permissions)
	<li><b>Transaction feedbacks:</b> allow you to give a <a
	href="${pagePrefix}transaction_feedback"><u> qualification</u></a> to a transaction.
	<li><b>send message</b> with the <a href="${pagePrefix}messages"><u>internal
	messaging system</u></a> of cyclos.
	<li><b>Send e-mail</b>
	<LI><b>Member documents:</b> This page gives access to page with member <a
