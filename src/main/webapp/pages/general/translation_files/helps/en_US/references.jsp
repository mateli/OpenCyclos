...
<br><br>
<span class="member">
<i>Where to find it.</i><br> To access the references given to you and given by
you, go to (Menu: Personal > References). <br> To access the references given
to and by another member, go to a members' <a href="${pagePrefix}profiles"><u>profile</u>
</a> and click &quot;View & give references&quot;.<br> To assign or update a
reference to a member, you also go to that member's profile and click
&quot;View & give references&quot;. </span>
<span class="broker">
...
This is an overview of received and given <a href="#top"><u>references</u></a>.
<br> 
...
This is a list of <a href="#top"><u>references</u></a> you have given to others. 
To change a reference, click the <img border="0" src="${images}/edit.gif"> icon.
<br>
To delete a reference, click the <img border="0" src="${images}/delete.gif"> icon.
<br>
If you click the member's &quot;name&quot; or &quot;login name&quot; you can go to the
<a href="${pagePrefix}profiles"><u>profile</u></a> of the member.
<hr class="help">
...
If the reference was given by you, you can change it. If the reference was 
given by someone else, you can only view it.<br>
If you click the member's &quot;name&quot; or &quot;login name&quot; you can go
to the <a href="${pagePrefix}profiles"><u>profile</u></a> of the member.
<hr class="help">


<br><br><a name="reference_details"></a>
<h3>Reference details</h3>
In this screen, you can view or change a <a href="#top"><u>reference</u></a>
to a member.
<span class="member"> You can only change references you have assigned yourself.<br>
