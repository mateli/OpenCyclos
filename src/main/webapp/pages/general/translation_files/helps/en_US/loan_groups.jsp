...
To view this item the administrator needs to have the correct <a
	href="${pagePrefix}groups#manage_group_permissions_admin_member"><u> permissions</u></a>
...
have the <a href="${pagePrefix}groups#manage_group_permissions_admin_member"><u>
permission</u></a> to give the loan (in permissions block &quot;loans&quot;)<br>
...
edit loan group > Give loan or via the <a
	href="${pagePrefix}profiles#actions_for_member_by_admin"><u> </u></a> (block Loans 
> Grant loan) </span>
...
<br><br>You can use the <img border="0" src="${images}/delete.gif" width="16" height="16">
...
<ul>
	...
	member for the group will receive the loan. If the permissions have been set, all
...
permissions. The actions mentioned here can only be done directly
