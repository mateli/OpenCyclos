...
Member records can be used to store information about members on
a one-to-many basis (meaning: one member can have many different values stored
in his &quot;member records&quot;). 

<span class="admin">
This distinguishes member records from <a
...
<a href="#edit_member_record_type"><u>list</u></a> type member record.<br>
...
<ul>
	...
	<li><b>Login name / Member name:</b> allow you to search records by the 
	member they are attributed to.
	<li><b>Broker Login / Broker name:</b> allow you to search records of members 
	attributed to a specific broker.
	<li><b>Registration date:</b> can be used to search on records by the date
...
<br>In addition to modifying the properties of the record, you should also
