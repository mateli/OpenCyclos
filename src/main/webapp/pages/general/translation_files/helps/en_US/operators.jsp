...
POSweb can be found at the Channels <a
	href="${pagePrefix}payments#accessing_channels"><u>Help page</u></a>.
<br><br>
...
<ul>
	<li><b>Buy with payment obligations</b></li>
	<li><b>Sell with payment obligations</b> 
	<li><b>Allowed guarantee types (for certifications)</b></li>
	<li><b>Issue certifications</b></li>
...
The <a href="#top"><u>operator</u></a> group configuration is divided in two
parts:
<ul>
