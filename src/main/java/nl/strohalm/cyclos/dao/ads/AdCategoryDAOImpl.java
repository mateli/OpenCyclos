...
public class AdCategoryDAOImpl extends BaseDAOImpl<AdCategory> implements AdCategoryDAO {
    ...
    public List<Long> getActiveCategoriesId() {
        ...
        JpaQueryHelper.addParameterToQuery(hql, namedParameters, "cat.active", true);
    ...
    public List<AdCategory> search(final AdCategoryQuery query) {
        ...
        if (query.getParent() != null) {
            JpaQueryHelper.addParameterToQuery(hql, namedParameters, "c.parent", query.getParent());
        } else {
        ...
        JpaQueryHelper.appendOrder(hql, order);
